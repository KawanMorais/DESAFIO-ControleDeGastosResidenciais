...
O banco de dados utilizado é o SQLite (em arquivo local chamado `ControleGastos.db`). As migrações correspondentes serão gerenciadas e aplicadas automaticamente na inicialização da aplicação.

1. Abra o terminal na pasta raiz do projeto.
2. Navegue até o diretório do backend:
   
   ```bash
   cd Backend/ControleGastosResidenciais/ControleGastosResidenciais
   ```
...
**Abra o endereço indicado no terminal** no seu navegador web para testar a aplicação.
